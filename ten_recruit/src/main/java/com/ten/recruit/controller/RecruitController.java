...
public class RecruitController {
	...
	public Result recomend(){
		List<Recruit> recomend = recruitService.findTop6ByStateOrderByCreatetimeDesc();
		return new Result(true,StatusCode.OK,"查询成功",recomend);
	}

	@RequestMapping(value="/search/newlist",method=RequestMethod.GET)
	public Result newlist(){
		List<Recruit> newlist = recruitService.findTop6ByStateNotOrderByCreatetimeDesc();
